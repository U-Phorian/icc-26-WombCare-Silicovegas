...
{
  0xf8, 0xf1, 0x70, 0x71, 0xf6, 0x64, 0x05, 0x9e, 0x9c, 0x47, 0xee, 0x9f, 0x97, 0x1e, 0xdd, 0xd1, 
};
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_24) = {
  .len = 16,
  .data = { 0xd0, 0xe6, 0xba, 0x92, 0xa5, 0x07, 0xbc, 0x95, 0xae, 0x48, 0xf5, 0x11, 0x03, 0x5a, 0x3c, 0xcd, }
};
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_10) = {
  .properties = 0x02,
  .max_len = 8,
  .data = { 0x57, 0x6f, 0x6d, 0x62, 0x43, 0x61, 0x72, 0x65, },
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x1b, .uuid = 0x8000, .permissions = 0x7871, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_26 },
  { .handle = 0x1c, .uuid = 0x000f, .permissions = 0xf03, .caps = 0xffff, .state = 0x00, .datatype = 0x03, .configdata = { .flags = 0x01, .clientconfig_index = 0x01 } },
  ...
  { .handle = 0x1f, .uuid = 0x000a, .permissions = 0x7871, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_30 },
  { .handle = 0x20, .uuid = 0x000f, .permissions = 0xf03, .caps = 0xffff, .state = 0x00, .datatype = 0x03, .configdata = { .flags = 0x01, .clientconfig_index = 0x02 } },
  { .handle = 0x21, .uuid = 0x000b, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_32 },
};
