...
REPO_DIR = ML_DIR.parent                             # repo root
CODE_DIR = REPO_DIR / "code"                         # teammates' data + scripts
PROCESSED_DIR = CODE_DIR / "processed_dat"           # cleaned FHR (teammates' output)
OUTCOMES_CSV = CODE_DIR / "outcomes.csv"             # pH/Apgar labels (teammates' output)
