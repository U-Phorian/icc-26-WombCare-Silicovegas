...
`WombCareFeatures_t` in [wombcare_dsp.h](../../projects/wombcare-firmware/inc/wombcare_dsp.h)):
...
- Firmware today: `W = 60 s` ([wombcare_buffer.h:11](../../projects/wombcare-firmware/inc/wombcare_buffer.h#L11)).
...
- **Firmware fix:** currently computed in ms on RR ([dsp.c:106](../../projects/wombcare-firmware/src/wombcare_dsp.c#L106)) →
...
- **Firmware fix:** currently hardcoded `0` ([dsp.c:132](../../projects/wombcare-firmware/src/wombcare_dsp.c#L132)) → implement.
- **Parity confidence:** Medium → **requires §6 calibration + §5 validation.**
...
- **Firmware fix:** currently counts single beats, not ≥15 s episodes
  ([dsp.c:111](../../projects/wombcare-firmware/src/wombcare_dsp.c#L111)) → add duration state-tracking.
...
- **Firmware fix:** currently set equal to `LB` ([dsp.c:94](../../projects/wombcare-firmware/src/wombcare_dsp.c#L94)) →
...
- **Firmware fix:** currently RR-interval variance
  ([dsp.c:99](../../projects/wombcare-firmware/src/wombcare_dsp.c#L99)) → change to FHR variance in bpm².
