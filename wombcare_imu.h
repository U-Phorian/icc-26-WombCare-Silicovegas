...
/* One-second processing window */
#define IMU_WINDOW_SECONDS      1U
...
/*
 * Discard the current one-minute window and sample buffers so the next
 * monitoring session starts fresh (call when monitoring stops/starts).
 */
